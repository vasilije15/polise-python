...
class InsuranceCard:
    ...
    def parse_pdf(self, path_to_file):
        ...
        for row in rows:
            ...
            if 33 < top < 41 and x1 > 450:
                print("zamjena: " + text)
                zamjena = text

            if 53 < top < 60 and x1 > 450:
            ...
            if 244 < top < 252 and x1 < 450:
                vrsta += text + ' '

            if 247 < top < 253 and x1 > 450:
                godina_proizvodnje = text

            if 266 < top < 272 and x1 < 450:
                marka_tip += text + ' '

            if 266 < top < 272 and x1 > 450:
                snaga_kw = text

            if 285 < top < 292 and x1 < 450:
                broj_sasije = text

            if 285 < top < 292 and x1 > 450:
                zapremina_ccm = text

            if 303 < top < 310 and x1 < 450:
                broj_motora = text

            if 303 < top < 310 and x1 > 450:
                broj_mjesta = text

            if 321 < top < 328 and x1 < 450:
                namjena += text + ' '
            ...
            if 584 < top < 594 and x1 < 450:
                porez = text

            if 584 < top < 594 and x1 > 450:
                za_naplatu = text

            if 755 < top < 764 and x1 < 300:
                sklopljeno_u = text
